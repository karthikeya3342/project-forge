...
export const useUiStore = create<CharacterState>()(
  (set) => ({
    ...
    // VANTAGE-specific
    vantageSessionId: null as string | null,
    setVantageSessionId: (id: string | null) => set({ vantageSessionId: id }),

    vantageHitl: null as { type: string; description: string } | null,
    setVantageHitl: (hitl: { type: string; description: string } | null) => set({ vantageHitl: hitl }),
